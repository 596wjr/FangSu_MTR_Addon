...
//
//public class ObjBlockUi extends SelectListScreen {
//
...
//
//    public ObjBlockUi(BlockPos blockPos) {
...
//                value -> {
//                    updateBlockEntity(be -> be.translateX = (value - 20) * 5f / 100f);
...
//                value -> {
//                    updateBlockEntity(be -> be.translateY = (value - 20) * 5f / 100f);
...
//                value -> {
//                    updateBlockEntity(be -> be.translateZ = (value - 20) * 5f / 100f);
...
//                value -> {
//                    updateBlockEntity(be -> be.rotateX = (float) Math.toRadians((value - 18) * 5f));
...
//                value -> {
//                    updateBlockEntity(be -> be.rotateY = (float) Math.toRadians((value - 18) * 5f));
...
//                value -> {
//                    updateBlockEntity(be -> be.rotateZ = (float) Math.toRadians((value - 18) * 5f));
...
//    }
//
//    private void updateBlockEntity(Consumer<BaseObjBlockEntity> modifier) {
...
//    }
//
//    private Optional<? extends BaseObjBlockEntity> getBlockEntity() {
//        Level level = Minecraft.getInstance().level;
//        if (level == null) return Optional.empty();
//        return level.getBlockEntity(editingBlockPos);
//    }
//
//    @Override
//    public void onClose() {
